/**
 * test-update-usdt-address.js — UPDATE_USDT_ADDRESS 爬虫自测
 */
...
async function main() {
    console.log('🧪 UPDATE_USDT_ADDRESS 爬虫自测');
    const task = await getTask();
    console.log(`   task: id=${task.id}, email=${task.email}, payment_address=${task.payment_address}\n`);
