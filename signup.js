                                            ...
                                            if (!loginUrl.includes('publishers.adsterra.com/login')) {
                                                ...
                                                while (Date.now() - waitStart < maxWaitBtn) {
                                                    ...
                                                    if (btnStatus.found && btnStatus.disabled) {
                                                        ...
                                                        // 每 6 秒主动尝试触发 Turnstile
                                                        if (elapsed > 2 && elapsed % 6 === 0 && tokenState.tsExists && !tokenState.tokenValue) {
                                                            console.log(`   🔄 主动触发 Login 页面 Turnstile (${elapsed}s)...`);
                                                            await tryResolveTurnstile(confirmPage);
                                                        }
