/**
 * test-create-payout.js — CREATE_PAYOUT 爬虫自测
 * 用法: node test-create-payout.js
 */
...
async function main() {
    console.log('🧪 CREATE_PAYOUT 爬虫自测');
    ...
    try {
        ...
        const result = await createPayoutCrawler(task, proxy, cookies);
